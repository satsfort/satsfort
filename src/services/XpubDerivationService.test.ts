...
describe("XpubDerivationService", () => {
    ...
    describe("validateExtendedKey", () => {
        it("validates a correct zpub", () => {
            expect(xpubDerivationService.validateExtendedKey(ZPUB_TEST)).toBeNull();
        });

        it("validates a correct xpub", () => {
            expect(xpubDerivationService.validateExtendedKey(XPUB_TEST)).toBeNull();
        });

        it("rejects an invalid key", () => {
            const result = xpubDerivationService.validateExtendedKey("xpub123invalid");
    ...
    describe("deriveAddressesFromExtendedKey", () => {
        it("derives P2WPKH addresses starting with bc1q", () => {
            const addresses = xpubDerivationService.deriveAddressesFromExtendedKey(ZPUB_TEST, "P2WPKH", 5);
        ...
        it("derives P2PKH addresses starting with 1", () => {
            const addresses = xpubDerivationService.deriveAddressesFromExtendedKey(XPUB_TEST, "P2PKH", 5);
        ...
        it("derives P2SH addresses starting with 3", () => {
            const addresses = xpubDerivationService.deriveAddressesFromExtendedKey(XPUB_TEST, "P2SH", 5);
        ...
        it("derives P2TR addresses starting with bc1p", () => {
            const addresses = xpubDerivationService.deriveAddressesFromExtendedKey(XPUB_TEST, "P2TR", 5);
        ...
        it("derives unique addresses for each index", () => {
            const addresses = xpubDerivationService.deriveAddressesFromExtendedKey(ZPUB_TEST, "P2WPKH", 10);
        ...
        it("derives the same addresses consistently", () => {
            const addresses1 = xpubDerivationService.deriveAddressesFromExtendedKey(ZPUB_TEST, "P2WPKH", 3);
            const addresses2 = xpubDerivationService.deriveAddressesFromExtendedKey(ZPUB_TEST, "P2WPKH", 3);
        ...
        it("converts zpub to xpub internally for derivation", () => {
            ...
            const zpubAddresses = xpubDerivationService.deriveAddressesFromExtendedKey(ZPUB_TEST, "P2WPKH", 3);
